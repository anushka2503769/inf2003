...
Authentication integration and Supabase configuration; account deletion and cleanup flows;
external job and LLM providers; normalization/role taxonomy; ranking and semantic method;
batch thresholds and
